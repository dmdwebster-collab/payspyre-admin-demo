...
import { LoanHeaderTabs } from "@/components/originations/loan-header-tabs";
...
export default async function ApplicationLayout({
  ...
  return (
    <>
      <Topbar
        title={`Loan Header · ${application.application_number}`}
        subtitle="Originations workplace · 10-tab Loan Header"
      />
      <div className="bg-navy-800 flex-1 overflow-y-auto">
        {/* Sticky borrower / vendor / status summary */}
        ...
        {/* Tab strip */}
        <LoanHeaderTabs applicationId={application.id} />
